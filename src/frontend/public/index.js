...
if (process.env.NODE_ENV === 'development') {
  ...
  canisterAssets.retrieve("worker.js").then((jsBytes) => {
    window.workerUrl = URL.createObjectURL(new Blob([new TextDecoder().decode(new Uint8Array(jsBytes))], { type: 'application/javascript; charset=utf-8' }))
